                                ...
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">Please Call <br> <a href="{{$contact->contact}}">{{$contact->contact}}</a>   </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white"> <a href="{{$contact->email}}">{{$contact->email}}</a></p> 
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white"> {{$contact->location}}</p> 
                                        </div>
                                    </div>
                                </div>
                                <div class="contact__info--items">
                                    ...
                                    <ul class="contact__info--social d-flex">
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="{{url($contact->facebook)}}">
                                        ...
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="{{url($contact->x)}}">
                                        ...
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="{{url($contact->skype)}}">
                                        ...
                                        <li class="contact__info--social__list">
                                            <a class="contact__info--social__icon" target="_blank" href="{{url($contact->youtube)}}">
                            ...
                            <div id="errorMessage" class="alert alert-danger" style="display: none;">
                                ...
                                <form class="contact__form--inner" id="formdata"  action="#" mathod="POST">
                                    ...
                                    <div class="row" id="myForm">
                                        <!-- <ul id="save_errorlis"></ul> -->
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input1">First Name <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input firstname" name="firstname" id="input1" placeholder="Your First Name" type="text">
                                                @error('firstname')
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                ...
                                                <input class="contact__form--input email" name="email" id="input4" placeholder="Email" type="text" >
                                                @error('email')
                                                 <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
