                                ...
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            ...
                                            <h2 class="slider__content--maintitle text-white h1">{{$slide->title}}</h2>
                                            <p class="slider__content--desc text-white mb-35 d-sm-2-none">{{$slide->des}}</p>    
                                            <a class="slider__content--btn primary__btn" href="{{url($slide->url)}}">Start to Buying</a>   
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hero__slider--items__inner">
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            <!-- <p class="slider__content--desc desc1 text-white mb-15">Discover our best furniture collection from home</p>  -->
                                            <h2 class="slider__content--maintitle text-white h1">best furniture</h2>
                                            <p class="slider__content--desc text-white mb-35 d-sm-2-none">Discover our best furniture collection from home</p>    
            ...
            <div class="row mb--n28">
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('newtheme/assets/img/banner/banner1.webp')}}" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('newtheme/assets/img/banner/banner2.webp')}}" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('newtheme/assets/img/banner/banner3.webp')}}" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items mb-25">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('newtheme/assets/img/banner/banner4.webp')}}" alt="banner-img">
                    ...
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{asset('newtheme/assets/img/banner/banner5.webp')}}" alt="banner-img">
    ...
    <section class="banner__section section--padding pt-0">
        <div class="container-fluid">
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                @forelse($topthree_products as $topproduct)
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img img-fluid" src="{{$topproduct->images[0]->url}}" alt="banner-img">
            ...
            <div class="row">
                <div class="col-xl-8 col-12 product__col--width__8">
                    <div class="product__section--wrapper">
                        <div class="section__heading style2 position__relative border-bottom mb-35">
                            <h2 class="section__heading--maintitle">Most Trending Products</h2>
                            <img class="section__heading--position__img" src="{{asset('newtheme/assets/img/other/heading-shape-img.webp')}}" alt="heading-shape-img">
                        </div>
                        <div class="product__section--inner">
                ...
                <div class="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
                    <div class="deals__banner--thumbnail">
                        <a class="deals__banner--thumbnail__link display-block position__relative" href="shop.html"><img class="deals__banner--thumbnail__img display-block" src="{{asset('newtheme/assets/img/banner/banner9.webp')}}" alt="deals-thumbnail-img">
    ...
    <div class="banner__video--section">
        <div class="container-fluid">
            <div class="banner__video--thumbnail position__relative">
                <img class="banner__video--thumbnail__img display-block" src="{{asset('newtheme/assets/img/banner/banner-bg1.webp')}}" alt="banner-bideo-thumbnail">
            ...
            <div class="row row-cols-xl-2 row-cols-1">
                <div class="col col-lg-order">
                    <div class="testimonial__banner--thumbnail">
                        <a class="display-block" href="shop.html"><img class="testimonial__banner--thumbnail__img display-block" src="{{asset('newtheme/assets/img/banner/banner10.webp')}}" alt="banner-img"></a>
                    </div>
                </div>
                <div class="col">
                                    ...
                                    <div class="testimonial__items">
                                        <div class="testimonial__items--topbar d-flex align-items-center">
                                            <div class="testimonial__items--thumbnail">
                                                <img class="testimonial__items--thumbnail__img display-block" src="{{asset('newtheme/assets/img/other/testimonial-thumb1.webp')}}" alt="testimonial-img">
                                            </div>
                                        ...
                                        <div class="testimonial__items--content">
                                            ...
                                            <p class="testimonial__items--desc">Mum ut perspiciatis unde omnis iste natus ganu
                                                error sit voluptatem accusan tium gyauey aykua
                                                doloremque sdggsuj jjsiaalji aialadju auoa.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial__items">
                                        <div class="testimonial__items--topbar d-flex align-items-center">
                                            <div class="testimonial__items--thumbnail">
                                                <img class="testimonial__items--thumbnail__img display-block" src="{{asset('newtheme/assets/img/other/testimonial-thumb2.webp')}}" alt="testimonial-img">
                                            </div>
                                            <div class="testimonial__items--author">
                                                <h3 class="testimonial__items--author__title h4">James Hamesk</h3>
    ...
    <section class="newsletter__banner--section section--padding pt-0">
        <div class="container-fluid">
            <div class="newsletter__banner--thumbnail position__relative">
                <img class="newsletter__banner--thumbnail__img display-block" src="{{asset('newtheme/assets/img/banner/banner-bg2.webp')}}" alt="newsletter-banner">
