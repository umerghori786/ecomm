        ...
        <div class="container-fluid">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.html"><img src="{{asset('newtheme/assets/img/logo/nav-log.webp')}}" alt="footer-logo"></a>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                ...
                <div class="footer__payment text-right">
                    <img class="footer__payment--visa__card display-block" src="{{asset('newtheme/assets/img/other/payment-visa-card.webp')}}" alt="visa-card">
                </div>
            </div>
        </div>
    </footer>
        ...
        <div class="newsletter__popup--inner">
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block" src="{{asset('newtheme/assets/img/banner/newsletter-popup-thumb.png')}}" alt="newsletter-popup-thumb">
                </div>
