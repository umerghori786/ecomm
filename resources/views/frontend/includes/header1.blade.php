    ...
    <header class="header__section header__section3 header__transparent mb-20 color-scheme-3">
            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{asset('newtheme/assets/img/logo/nav-log3.webp')}}" alt="logo-img"></a></h1>
                    </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="{{asset('newtheme/assets/img/logo/nav-log3.webp')}}" alt="Furea Logo">
                    </a>
        ...
        <div class="predictive__search--box color-scheme-3" tabindex="-1">
            <div class="predictive__search--box__inner">
                ...
                <form id="searchProductFormHome" autocomplete="off" class="predictive__search--form">
                    <label>
                        <input name="searchProduct" class="predictive__search--input" placeholder="Search Here" type="text">
                    </label>
