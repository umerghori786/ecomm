	                    ...
	                    <div class="product__details--media">
	                        <div class="product__media--preview  swiper">
                                <div class="swiper-wrapper">
                                    <!-- <div class="swiper-slide" v-for="image in product.image">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" ><img class="product__media--preview__items--img" v-bind:src="image.url" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" ><img class="product__media--preview__items--img" src="{{asset('newtheme/assets/img/product/big-product3.webp')}}" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" data-gallery="product-media-preview">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" v-for="image in product.images">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" v-bind:src="image.url" alt="product-nav-img">
                                        </div>
                                    </div>
	...
	export default{
		...
		methods:{
			getProduct()
			{
				...
				const req = axios.get(`/api/product/show/${this.$route.params.id}`)
									.then((response)=>{
