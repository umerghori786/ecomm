                      ...
                      <nav class="header__menu--navigation">
                          <ul class="d-flex">
                              <li class="header__menu--items">
                                  <a class="header__menu--link" href="#"><router-link v-bind:to="{name:'indexpage'}">Products</router-link> </a>
                              ...
                              <li class="header__menu--items mega__menu--items">
                                  ...
                                  <ul class="header__mega--menu d-flex">
                                      ...
                                      <li class="header__mega--menu__li" v-for="cat in category">
                                          <span class="header__mega--subtitle">{{cat.title}}</span>
                                          <ul class="header__mega--sub__menu">

                                              <li class="header__mega--sub__menu_li" v-for="subcat in cat.subcategories">
                                                <!-- https://techformist.com/url-params-vue/ -->
                                                <router-link v-bind:to="{name:'indexpage' , query: { subcategory_id: subcat.id }}"> <a class="header__mega--sub__menu--title" href="#">
                                                  {{subcat.title}}
                                                </a>
                                                </router-link>
                                              </li>
                              ...
                              <li class="header__menu--items">
                                  <a class="header__menu--link"><router-link v-bind:to="{name:'about_us'}">  About US </router-link></a>  
                              </li>
                              
                             
                              <li class="header__menu--items">
                                  <a class="header__menu--link" > <router-link v-bind:to="{name : 'contact_us'}"> Contact </router-link> </a>  
                              </li>
                          </ul>
                      </nav>
                  </div>
              ...
              <nav class="offcanvas__menu">
                  <ul class="offcanvas__menu_ul">
                      <li class="offcanvas__menu_li">
                          <a class="offcanvas__menu_item" href="#"><router-link v-bind:to="{name: 'indexpage'}">Products</router-link></a>
                         
                      </li>
                      <li class="offcanvas__menu_li">
                          <a class="offcanvas__menu_item" href="#">Shop </a>
                          <ul class="offcanvas__sub_menu">
                              <li class="offcanvas__sub_menu_li" v-for="cat in category">
                                  <a href="#" class="offcanvas__sub_menu_item">{{cat.title}}</a>
                                  <ul class="offcanvas__sub_menu">
                                      <li class="offcanvas__sub_menu_li" v-for="subcat in cat.subcategories"> 
                                        <router-link v-bind:to="{name:'indexpage' ,query: { subcategory_id: subcat.id }}"> 
                                        <a class="offcanvas__sub_menu_item" href="#">
                                        {{subcat.title}}
                                        </a>
                                        </router-link>
                                    </li>
                      ...
                      <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="#"><router-link v-bind:to="{name : 'about_us'}">About</router-link></a></li>
                      <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="#"><router-link v-bind:to="{name : 'contact_us'}"> Contact</router-link></a></li>
                  </ul>
      ...
      <div class="offcanvas__stikcy--toolbar" tabindex="-1">
          <ul class="d-flex justify-content-between">
              ...
              <li class="offcanvas__stikcy--toolbar__list">
                  ...
                  <router-link v-bind:to="{name:'shop'}"><span class="offcanvas__stikcy--toolbar__label">Shop</span></router-link>
                  </a>
              </li>
              <li class="offcanvas__stikcy--toolbar__list ">
    ...
    <footer class="footer__section footer__bg">
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            <h2 class="footer__widget--title d-none d-md-block"><router-link v-bind:to="{name : 'about_us'}">About Us </router-link><button class="footer__widget--button" aria-label="footer widget button"></button>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#"><router-link v-bind:to="{name : 'about_us'}">About Us</router-link></a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="wishlist.html">Wishlist</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#"><router-link v-bind:to="{name : 'contact_us'}">Contact Us</router-link></a></li>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content  m-0">Copyright © 2023 <a class="copyright__content--link" href="index.html">Furea</a> . All Rights Reserved.Design By KABIRA</p>
...
<script type="text/javascript">
  ...
  export default{
    ...
    methods:{
      getCategory()
      {
        const req = axios.get(`/api/categeory`)
                          .then((response)=>{
