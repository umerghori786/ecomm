<template>
	<div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n25" v-if="data">

	    <div class="col mb-25" v-for="i in data">
	        <div class="product__items">
	            <div class="product__items--thumbnail">
	                <a v-if="i.images"  class="product__items--link" href="product-details.html">
	            ...
	            <div class="product__items--content style2 position__relative">
	                ...
	                <div class="product__items--price style2">
	                    <span class="current__price style2">${{i.discount_price}}</span>
	                    <span class="old__price style2">${{i.strike_price}}</span>
	                </div>
