	...
	<main class="main__content_wrapper">
	            ...
	            <div class="row mb--n28">
	                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
	                    <div class="banner__items">
	                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="../assets/img/banner/banner1.webp" alt="banner-img">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
	                    <div class="banner__items">
	                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="../assets/img/banner/banner2.webp" alt="banner-img">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
	                    <div class="banner__items">
	                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="../assets/img/banner/banner3.webp" alt="banner-img">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
	                    <div class="banner__items mb-25">
	                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="../assets/img/banner/banner4.webp" alt="banner-img">
	                    ...
	                    <div class="banner__items">
	                        <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="../assets/img/banner/banner5.webp" alt="banner-img">
	    ...
	    <section class="product__section section--padding pt-0">
	        <div class="container-fluid">
	            ...
	            <popularItem v-bind:data="popularItem"></popularItem>
	        </div>
	    </section>
	    <!-- End product section -->
	                ...
	                <div class="col-xl-8 col-12 product__col--width__8">
	                    <div class="product__section--wrapper">
	                        <div class="section__heading style2 position__relative border-bottom mb-35">
	                            <h2 class="section__heading--maintitle">Trending Items</h2>
	                            <!-- <img class="section__heading--position__img" src="../assets/img/other/heading-shape-img.webp" alt="heading-shape-img"> -->
	                        </div>
	                        <div class="product__section--inner">
	                            <trendingItem v-bind:data="trending_products"></trendingItem>
	                        </div>
	                    </div>
	                </div>
	                <div class="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
	                    <div class="deals__banner--thumbnail">
	                        <a class="deals__banner--thumbnail__link display-block position__relative" href="shop.html"><img class="deals__banner--thumbnail__img display-block" src="../assets/img/banner/banner9.webp" alt="deals-thumbnail-img">
...
<script type="text/javascript">
	...
	export default{
		...
		created()
		{
			const req = axios.get('api/home')
							.then((response)=>{
								this.popularItem = response.data.popular_products;
								this.trending_products = response.data.trending_products;
							}).then(()=>{
								this.loading = true;
							})
		}
