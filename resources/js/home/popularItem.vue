	...
	<div class="tab_content">
	    <div id="chair" class="tab_pane active show">
	        <div class="product__section--inner">
	            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30" v-if="data">
	                <div class="col mb-30" v-for="i in data" :key="i">
	                    <div class="product__items ">
	                        <div class="product__items--thumbnail">

	                            <a class="product__items--link" href="product-details.html" v-if="i.images">
	                                
	                                <img  class="product__items--img product__primary--img" v-bind:src="i.images.at(0).url" alt="product-img">
	                                <img class="product__items--img product__secondary--img" v-bind:src="i.images.at(1).url" alt="product-img">
	                        ...
	                        <div class="product__items--content text-center">
	                            ...
	                            <h3 class="product__items--content__title h4"><a href="#">{{i.title}}</a></h3>
	                            
	                            <div class="product__items--price">
	                                <span class="current__price">${{i.discount_price}}</span>
	                                <span class="old__price">${{i.strike_price}}</span>
	                            </div>
