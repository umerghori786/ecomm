...
@section('content')
                    ...
                    <div class="row container">
                        <div class="col-md-9">
                            <h4 class="page-title d-inline">@lang('Update Office Address')</h4>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="mt-5">
                    {!! Form::model($contact, ['method' => 'PUT', 'route' => ['contact.update',$contact->id], 'files' => true,]) !!}
                       
                        <div class="row justify-content-center container">
                            <div class="col-12 col-lg-12 form-group">
                                {!! Form::label('Phone no', 'Phone No'.' *', ['class' => 'control-label']) !!}
                                {!! Form::text('contact', old('contact'), ['class' => 'form-control', 'placeholder' => 'Contact Us', 'required' => true]) !!}
                                @error('contact')
