...
@if(isset($logo))    
<a class="mx-auto" href="{{route('admin.dashboard')}}"><img src="{{asset('logo/'.$logo->image)}}" style="max-width:200px; max-height: 50px;" class="ing-fluid" alt=""></a>
@else
...
<li><a  href="{{route('sizes.index')}}">@if(config('app.language') == 'en') Sizes @else {{ GoogleTranslate::trans('Sub Category', app()->getLocale()) }} @endif</a></li>
