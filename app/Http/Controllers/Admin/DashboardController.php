...
class DashboardController extends Controller
{
    ...
    */
    ...
    {   
        ...
        /*end*/
        return view('backend.home',compact('count_category','count_sub_category','count_contactus','count_reviews','count_orders','today_income','total_income','monthly_income','product_count'));
    }
